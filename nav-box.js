...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div style="position: fixed; top: 15px; left: 15px; z-index: 9999;">
        ...
        ">
            ...
            <a href="/spaces.html" style="display: block; padding: 8px 12px; color: #333; text-decoration: none; ${currentPage === 'spaces.html' ? 'background: #e8edf6; font-weight: 600; color: #1a3c8b;' : ''}" onmouseover="if('${currentPage}' !== 'spaces.html') this.style.background='#edf0f9'" onmouseout="if('${currentPage}' !== 'spaces.html') this.style.background='white'">HuggingFace Spaces Gallery</a>

...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div style="position: fixed; top: 15px; left: 15px; z-index: 9999;">
        ...
        ">
            ...
            <a href="cft.html" style="display: block; padding: 8px 12px; color: #333; text-decoration: none; ${currentPage === 'pdfmerger.html' ? 'background: #f6eee3; font-weight: 600; color: #8b4513;' : ''}" onmouseover="if('${currentPage}' !== 'pdfmerger.html') this.style.background='#f9f5eb'" onmouseout="if('${currentPage}' !== 'cft.html') this.style.background='white'">Doc/Audio/Data Converter, .GIF Creator & Collage Maker</a>

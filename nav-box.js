...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div style="position: fixed; top: 15px; left: 15px; z-index: 9999;">
        ...
        ">
            ...
            <a href="/subscribe.html" style="display: block; padding: 8px 12px; color: #1a3c8b; text-decoration: none; font-weight: 600; background: ${currentPage === 'subscribe.html' ? '#e8edf6' : '#f0f8e8'}; border-left: 3px solid #28a745;" onmouseover="this.style.background='#e4f2d8'" onmouseout="this.style.background='${currentPage === 'subscribe.html' ? '#e8edf6' : '#f0f8e8'}'">Pro Plan - $4.99/mo</a>

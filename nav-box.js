...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div style="position: fixed; top: 15px; left: 15px; z-index: 9999;">
        ...
        ">
            ...
            <a href="pfppreview.html" style="display: block; padding: 8px 12px; color: #333; text-decoration: none; ${currentPage === 'pfppreview.html' ? 'background: #e8edf6; font-weight: 600; color: #1a3c8b;' : ''}" onmouseover="if('${currentPage}' !== 'pfppreview.html') this.style.background='#edf0f9'" onmouseout="if('${currentPage}' !== 'pfppreview.html') this.style.background='white'">Profile Picture Preview</a>
